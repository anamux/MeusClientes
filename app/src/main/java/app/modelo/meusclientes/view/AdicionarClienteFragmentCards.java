...
public class AdicionarClienteFragmentCards extends Fragment {
///DECLARAÇÃO GLOBAL DOS atributos (PUBLIC)
    ...
    public AdicionarClienteFragmentCards() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.adicionar_cliente_fragment_cards, container, false);
